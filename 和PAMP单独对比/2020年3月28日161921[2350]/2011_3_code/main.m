...
set(gcf,'Position',[100 100 375 375]);
set(gca,'Position',[.14 .14 .83 .83]);  %调整 XLABLE和YLABLE不会被切掉
figure_FontSize=8;
...
curve=semilogy(dB,compare_data(2,:),'--dr',dB,compare_data(4,:),'-.>r',dB,compare_data(10,:),':*b',dB,compare_data(11,:),'--ok');
...
legend('MC (Barycenter)','Proposed MC-TR','PAMP in [20]','CRLB-TOA','Location','southwest')
