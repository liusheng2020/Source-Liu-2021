...
%% 绘图
figure(2)
set(gcf,'Position',[100 100 430 430]);
...
grid on;
%legend('show')
legend('MC B','Proposed MC B TR','2LS in [15]','MMA in [15]','SDP 2016 in [14]','SDP 2013 in [19]','Classic TDOA in [2]','PAMP\_Chen','CRLB-TOA','CRLB-TDOA','Location','southwest')
ylim([.01 6]);
%% 导出到pdf
%
